...
export function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden w-full min-h-screen flex items-center justify-center">
          ...
          <div className="px-2">
            <div className="border-ali relative mx-auto h-full max-w-7xl border p-6 [mask-image:radial-gradient(800rem_96rem_at_center,white,transparent)] md:px-12 md:py-20">
              <h1 className="flex select-none flex-col px-3 py-2 text-center text-5xl font-semibold leading-none tracking-tight md:flex-col md:text-8xl lg:flex-row lg:text-8xl">
                <DIcons.Plus
                  className="text-ali absolute -left-5 -top-5 h-10 w-10 text-cyan-500"
                />
                <DIcons.Plus
                  className="text-ali absolute -bottom-5 -left-5 h-10 w-10 text-cyan-500"
                />
                <DIcons.Plus
                  className="text-ali absolute -right-5 -top-5 h-10 w-10 text-cyan-500"
                />
                <DIcons.Plus
                  className="text-ali absolute -bottom-5 -right-5 h-10 w-10 text-cyan-500"
                />
      ...
      <canvas
        className="bg-skin-base pointer-events-none absolute inset-0 mx-auto w-full h-full"
        id="canvas"
      ></canvas>
    </section>
  );
